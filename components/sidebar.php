<aside class="bg-white p-6 rounded-lg shadow order-last lg:order-none">
  ...
  <div class="flex flex-col items-center text-center">
    ...
    <div class="flex gap-3 mt-3">
      <a href="https://x.com/Abhishe96895508" class="text-blue-500">Twitter</a>
      <a href="https://www.instagram.com/abhishekchowdhury_30/" class="text-pink-500">Instagram</a>
      <a href="https://abhishek213-013.github.io/WebDevPortfolio/" class="text-gray-700">Website</a>
    </div>
  </div>
</aside>
