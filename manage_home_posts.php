...
$categoriesResult = $conn->query("SELECT DISTINCT category FROM posts WHERE category IS NOT NULL AND category <> ''");
$authorsResult    = $conn->query("SELECT DISTINCT author FROM posts WHERE author IS NOT NULL AND author <> ''");
